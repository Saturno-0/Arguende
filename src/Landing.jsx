...
function Landing() {
    ...
    return (
        ...
        <div id="landing" className="flex h-screen bg-[url(/src/assets/FacadeArguende.jpg)] md:bg-size-[70%] bg-fixed bg-cover md:bg-position-[left_40%] bg-center md:justify-end bg-no-repeat">
            ...
            <div className="bg-black/30 backdrop-blur-sm  rounded-3xl md:rounded-none absolute text-xl md:relative md:my-0 md:items-end self-center mx-15 mt-70 md:mx-0 md:self-auto md:flex  md:bg-[#282828] md:p-15  md:w-1/3 pb-5 px-5">
